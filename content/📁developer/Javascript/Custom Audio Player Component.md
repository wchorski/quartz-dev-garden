...
Following [this video tutorial](https://www.youtube.com/watch?v=rkqqBA6ohc0&t=10s) I was able to create something from vanilla [Javascript](📁developer/Javascript.md) with a [ReactJS](📁developer/ReactJS/ReactJS.md) like structure. 

plans to port this over to a real [ReactJS](📁developer/ReactJS/ReactJS.md) are to follow --> [Custom Audio Player Component - ReactJS Port](📁developer/ReactJS/Custom%20Audio%20Player%20Component%20-%20ReactJS%20Port.md)
